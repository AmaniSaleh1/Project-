...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        jewelry_data = [
            {'title': 'Gold Necklace', 'type': 'Necklace', 'price': 299.99, 'edition': 10},
            {'title': 'Silver Ring', 'type': 'Ring', 'price': 99.99, 'edition': 100},
            {'title': 'Diamond Earrings', 'type': 'Earrings', 'price': 499.99, 'edition':5},
            {'title': 'Platinum Bracelet', 'type': 'Bracelet', 'price': 399.99, 'edition': 14},
        ]
